...
//--------------------------------------------------------------
gamefix_iniFileSection* gamefix_iniParseSections(const str& file, const char* data, int* section_count) {
	*section_count = 0;
...
//--------------------------------------------------------------
str gamefix_iniGetSection(const str& file, const str& data, const char* section_name)
{
	int section_count;
	gamefix_iniFileSection* sections = gamefix_iniParseSections(file, data, &section_count);
	str result = "";
...
// Added: Support for ini-files
// Replaces or adds content to the given section
//--------------------------------------------------------------
str gamefix_iniSectionUpdate(const str& file, const str& file_contents, const str& section_name, const str& new_section_contents)
{
...
//--------------------------------------------------------------
str gamefix_iniSectionRemove(const str& file, const str& file_contents, const str& section_name)
{
	str modified_contents = file_contents;
	str trimmed_section_name = "[" + gamefix_trimWhitespace(section_name,false) + "]";
	int section_start = gamefix_findStringCase(modified_contents, trimmed_section_name, false, 0);
